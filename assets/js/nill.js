...
$('#major').on('click',function(){
    $('.major').addClass('display-block');
    $('.minor').addClass('display-none');
    $('.major').removeClass('display-none');
    $('.minor').removeClass('display-block');
})

$('#minor').on('click',function(){
    $('.major').removeClass('display-block');
    $('.minor').removeClass('display-none');
    $('.major').addClass('display-none');
    $('.minor').addClass('display-block');
})